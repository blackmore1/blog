...
<div class="layui-fluid">
    <div class="layui-row">
        <form class="layui-form">
            ...
            <input type="text" name="publishDate" style="display: none" value="${article.publishDate}" />
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <select name="keyword" lay-verify="required" lay-search="">
                        <#list tags as tag>
                            <option value="${tag.word}" <#if article.keyword==tag.word>selected="selected"</#if>>${tag.word}</option>
                        </#list>
                    </select>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="picture" name="picture" required=""
                           autocomplete="off" class="layui-input" value="${article.picture!}">
                </div>
            </div>
            <div class="layui-form-item">
